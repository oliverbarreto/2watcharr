...
- **Filter Bar**: Integrated Liked/Disliked filters into the [filter-bar.tsx](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/components/features/episodes/filter-bar.tsx) to allow users to easily find their favorite or disliked content.
