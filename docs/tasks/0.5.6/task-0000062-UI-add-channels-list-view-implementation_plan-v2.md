...
Refine the UI to match [EpisodeListRow](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/components/features/episodes/episode-list-row.tsx#48-674) style:
- [ ] Increase thumbnail size (e.g., from `16x16` to `32x32` or similar).
- [ ] Align name and metadata layout with [EpisodeListRow](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/components/features/episodes/episode-list-row.tsx#48-674).
- [ ] Limit description width to avoid stretching.
- [ ] Adjust padding and spacing to match.
