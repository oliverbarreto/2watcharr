...
- **Case-insensitive search**: Filters table entries by title using partial matching
- **Real-time filtering**: Results update as you type
- **Auto-reset pagination**: Automatically returns to page 1 when search query changes
