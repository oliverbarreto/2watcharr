...
- **Tags**: A brand new tab featuring a time-series chart of videos watched per tag.
    - *Layout*: The chart takes priority at the top, followed by a full-width **Visible Tags** section where tags are spread horizontally for better visibility.
    - *Efficiency*: Added **Select All** and **Deselect All** buttons to quickly manage large numbers of tags.
