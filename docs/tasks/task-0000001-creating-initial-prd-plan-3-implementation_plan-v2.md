...
**Summary**: Bootstrap a Next.js 16+ application with TypeScript, Tailwind CSS, and shadcn/ui. Set up the foundational project structure following Clean Architecture principles.
...
3. Install core dependencies:
   - `sqlite3` for plain SQLite support
   - `@types/sqlite3` for TypeScript support
   - `sqlite` (optional wrapper for promise-based API)
