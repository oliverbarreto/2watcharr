...
2.  **Service Method**: Added [syncChannelMetadata](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/lib/services/media.service.ts#295-309) to [MediaService](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/lib/services/media.service.ts) to allow individual syncing from both the API and existing batch sync.
...
- **Syntax Check**: Verified Next.js 15+ compatibility for dynamic route parameters and event propagation.
