...
- Ran unit tests for [MediaService](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/lib/services/media.service.ts#12-259) and [EpisodeRepository](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/lib/repositories/episode.repository.ts#12-438).
- All tests passed successfully (7 tests in total).
- Cleaned up obsolete debug scripts ([diagnose_db.ts](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/diagnose_db.ts)) and resolved build artifact conflicts.
