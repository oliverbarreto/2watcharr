...
- Updated [moveToBeginning](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/lib/repositories/episode.repository.ts#620-629) and [moveToEnd](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/lib/repositories/episode.repository.ts#630-639) to include **all** non-deleted episodes when calculating the new order.
...
- Updated [setPriority](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/lib/services/media.service.ts#325-335) **and** [updateEpisode](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/lib/services/media.service.ts#164-192) to automatically trigger [moveToBeginning](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/lib/repositories/episode.repository.ts#620-629) when an episode is marked as `high` priority. This ensures correct placement regardless of which API endpoint is used (context menu or general edit).
- Updated [saveEpisodeFromMetadata](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/lib/services/media.service.ts#42-143) to automatically move **newly created** episodes to the beginning of the list. This ensures they appear at the top of the Watch Next page immediately.
...
2. **Priority Test**: [media.service.priority.test.ts](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/lib/services/media.service.priority.test.ts)
   - Verified that calling [setPriority(id, 'high')](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/lib/services/media.service.ts#325-335) automatically moves the episode to the top of the manual queue.
...
| Move to Beginning with high priority (API/Service) | ✅ Passed |
| Top-placement for newly created episodes | ✅ Passed |
