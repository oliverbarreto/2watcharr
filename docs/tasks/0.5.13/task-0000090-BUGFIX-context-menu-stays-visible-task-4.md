...
- [ ] Implementation
    - [ ] Update [GroupedEpisodeList](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/components/features/episodes/grouped-episode-list.tsx#18-78) to accept and pass `showReorderOptions`
    - [ ] Update [EpisodeList](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/components/features/episodes/episode-list.tsx#57-356) to pass `showReorderOptions` to [GroupedEpisodeList](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/components/features/episodes/grouped-episode-list.tsx#18-78)
- [ ] Verification
    - [ ] Verify "Move to..." options are hidden on Watchlist
    - [ ] Verify "Move to..." options are visible on Watch Next
