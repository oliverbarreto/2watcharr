...
We want to implement the same UX for the videos per tag to add:
- Add a search textfield for filtering visible tags in the chart
- Add top 5 reset button. We are right now showing the chart with 5 tags visible, but i don't knmow if they are the first 5 alphabetically ordered, or the top 5 most used tags. We want the later)
