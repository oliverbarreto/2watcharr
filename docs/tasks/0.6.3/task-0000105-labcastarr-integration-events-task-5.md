...
- [x] Implement Backend Logic (V1)
    ...
    - [x] Create [NotificationRepository](file:///Users/oliver/local/dev/2watcharr/src/lib/repositories/notification.repository.ts#28-185)
...
- [/] Notification Events V2
    - [ ] Update [NotificationType](file:///Users/oliver/local/dev/2watcharr/src/lib/utils/notification-helpers.ts#45-74) models
    - [ ] Update [NotificationService](file:///Users/oliver/local/dev/2watcharr/src/lib/services/notification.service.ts#5-120) logging methods
    - [ ] Refine [MediaService](file:///Users/oliver/local/dev/2watcharr/src/lib/services/media.service.ts#19-665) local addition flow (Requested -> Initiated -> Finalized)
    - [ ] Refine [IntegrationService](file:///Users/oliver/local/dev/2watcharr/src/lib/services/integration.service.ts#14-136) LabcastARR flow (Sent Initiated -> Sent Completed/Failed)
    - [ ] Update UI helpers with new labels and icons
