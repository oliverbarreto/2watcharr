...
- [x] Notification Events V2
    ...
    - [x] Refine [MediaService](file:///Users/oliver/local/dev/2watcharr/src/lib/services/media.service.ts#19-686) local addition flow (Requested -> Initiated -> Finalized)
...
- [/] Asynchronous Episode Addition & Notification UI
    - [ ] Create `addEpisodeBackground` logic in `MediaService.ts`
    - [ ] Update API route to return 202 Accepted
    - [ ] Update frontend modal to handle async response
    - [ ] Implement `NotificationBell` component with unread count
    - [ ] Implement polling/toast logic for new events
    - [ ] Integrate bell into Navbar
