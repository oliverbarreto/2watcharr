...
1. CTRL+F, CMD+F (macOS) shows the search and filters panel
...
- CTRL+4, CMD+4 to navigate to "/stats"
- CTRL+,, CMD+, to navigate to "/setttings"
- CTRL+SHIFT+A, CMD+SHIFT+A to open the add new episode modal
