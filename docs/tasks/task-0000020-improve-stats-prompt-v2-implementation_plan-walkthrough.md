...
### Frontend
- **New UI Components**:
    - Added Shadcn [Select](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/components/ui/select.tsx#9-14) and [Table](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/components/ui/table.tsx#7-18) components.
- **Stats Page**:
    - Implemented period selection via a [Select](file:///Users/oliver/_HD_LOCAL/dev/2watcharr/src/components/ui/select.tsx#9-14) dropdown inside the **Activity Trend** chart header, following the Shadcn interactive chart pattern.
    - Implemented a **Detailed History** table with **client-side sorting** by Title, Type, Action, and Date.
