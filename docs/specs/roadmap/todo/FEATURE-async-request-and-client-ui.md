# Task: Async Request and Client UI

We want to implement async requests and a client ui for the requests. This will allow us to show a loading screen while the request is being processed in the background. 
