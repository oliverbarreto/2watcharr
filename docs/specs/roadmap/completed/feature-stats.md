...
- [x] Add a stats page to show total videos, total podcasts, total channels, total tags, etc.
- [x] Add a stats about usage of the entries in the watch list: videos added/watched/favorited/removed/tagged by day/week/month, etc.
- [x] Add a stats about play time. Videos marked as watched are added to the play time. We should have total play time and average play time per video. Also by dates, today, this week, this month, this year, other custom date ranges, etc.
- [x] When we click a video card and it opens the youtube video in a new tab, we could either 
